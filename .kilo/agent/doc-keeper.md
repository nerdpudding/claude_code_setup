---
# GENERATED by kilo-sync from .claude/agents/doc-keeper.md - do not edit; edit the source and re-run.
...
6. **Agents table** — verify it matches the actual `.kilo/agent/` contents.
