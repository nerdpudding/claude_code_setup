...
### 0.3 Orphaned plans
Check `~/.claude/plans/` — it should be empty. All plans should be project-local. If orphaned plans exist, ask the user if they can be deleted.

### 0.4 Global skills
Verify this skill exists at `~/.claude/skills/project-setup/SKILL.md`.
