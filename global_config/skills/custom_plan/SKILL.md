...
for anything user-facing. Scale it to the project: cover what matters and stop. If exhaustive
edge-case testing IS warranted here, say why; otherwise it is cost without value.
```
...
feed the milestone review when one comes.
